...
var ClassVisualization = function(){
    ...
    this.init_image_details = function(){
        ...
        document.addEventListener('mousewheel', $("#canvas_gt")[0], {passive: false});
        document.addEventListener('mousewheel', $("#canvas_det")[0], {passive: false});
        ...
        $("#canvas_gt").bind('wheel', function(e) {self.mousewheel(e);});
        ...
        $("#canvas_det").bind('wheel', function(e) {self.mousewheel(e);});
    ...
    this.mousewheel = function(e){     
         var new_scale = this.scale + ((e.originalEvent.deltaY<0)? this.scale*0.1 : -this.scale*0.1);
...
$(document).ready(function () {
    if ($("#div_comparation").find("tr.current").length){
        $("#div_comparation").scrollTop($("#div_comparation").find("tr.current").offset().top);
    }
