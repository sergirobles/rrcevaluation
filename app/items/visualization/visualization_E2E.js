/* global visualization, ClassVisualization */
            ...
            for ( var k=0;k<sampleData.pairs.length;k++){
                ...
                for(var i=0;i<gts.length;i++){
                    for(var j=0;j<dets.length;j++){
                        stylesMat[gts[i]][dets[j]] += " " + (pair.correct? "OO" : "NO");
                        sampleData.gtTypes[gts[i]] = (pair.correct? "OO" : "NO");
                        sampleData.detTypes[dets[j]] = (pair.correct? "OO" : "NO");
                    }
                }
            }
        }
...
ClassVisualization.prototype.draw = function(){
    ...
    if (this.sampleData==null || this.sampleData.gtPolPoints==undefined){
        this.ctx_gt.fillStyle = "rgba(255,0,0,1)";
        this.ctx_gt.font= "12px Verdana";
